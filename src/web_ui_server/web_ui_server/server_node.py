...
class WebUIServerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('cert_file', os.path.join(pkg_share, 'certs', '192.168.2.8+2.pem'))
        self.declare_parameter('key_file',  os.path.join(pkg_share, 'certs', '192.168.2.8+2-key.pem'))
